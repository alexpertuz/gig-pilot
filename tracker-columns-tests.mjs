 ...
 * GIG_OPS_TRACKER / GIG_OPS_ADDITIONS env overrides and assert:
...
function runScript(script, args, sandbox) {
  const env = {
    ...process.env,
    GIG_OPS_TRACKER: sandbox.tracker,
    GIG_OPS_ADDITIONS: sandbox.additions,
    GIG_OPS_TRACKER_LOCK: sandbox.lock,
  };
  try {
