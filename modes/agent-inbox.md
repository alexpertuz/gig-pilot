...
A durable bridge between *looking at* the pipeline and *acting on* it. gig-pilot
...
```bash
node agent-inbox.mjs add "evaluate https://www.reddit.com/r/forhire/comments/abc/"
node agent-inbox.mjs add "draft a proposal for lead #7"
...
```markdown
- [ ] 2026-06-21 09:30 — evaluate https://www.reddit.com/r/forhire/comments/abc/
...
4. Items that need **live user input** (a live client call, a pasted brief, a
   decision, anything that would send a proposal) → do **not** run them;
